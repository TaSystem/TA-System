...
const RequestTAs = (props) => {
  ...
  const applyTA = async (hr) => {
    let total =
      parseInt(number1 ? number1 : 0) + parseInt(number2 ? number2 : 0);
        ...
        <div className="row align-items-center">
          <div className="col">
            <input
              ...
              type="number"
              placeholder="จำนวนนิสิตปริญญาตรี"
              onChange={(e) => {
          ...
          <div className="col">
            <input
              className="form-control"
              type="number"
              placeholder="จำนวนนิสิตปริญญาโท"
              onChange={(e) => {
      ...
      <div style={{ paddingTop: '10px' }}>
        {course != null && course.length != 0 ? (
          <button
            ...
            onClick={() =>
              applyTA(
                hourTA(course[0].sec_D, course[0].sec_P, course[0].courseID)
              )
            }
          >
            {' '}
